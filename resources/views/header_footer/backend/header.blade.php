        ...
        <div class="content-header-section">
            ...
            <div class="btn-group" role="group">
                ...
                <div class="dropdown-menu dropdown-menu-right min-width-200" aria-labelledby="page-header-user-dropdown">
                    <h5 class="h6 text-center py-10 mb-5 border-b"><img src="{{isset($settings->logo) ? Storage::url($settings->logo) : asset('media/frontend_imgs/logo.png') }}" width="60" height="20">IECA</h5>
                    <a class="dropdown-item" href="{{ route('admin.staff.edit', auth()->user()->id) }}">
                    ...
                    <!-- Toggle Side Overlay -->
                    <!-- Layout API, functionality initialized in Template._uiApiLayout() -->
                    <a class="dropdown-item" href="{{ route('admin.settings.index')}}" data-toggle="layout" data-action="side_overlay_toggle">
